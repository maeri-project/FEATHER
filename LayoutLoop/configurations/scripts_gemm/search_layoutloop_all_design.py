...
########### Must Change
test_list = ["SIGMA", "eyeriss_like", "simba_like"]
########### Must Change
...
map_constraint_dict = {
    "SIGMA":             "",
    "eyeriss_like":      "../arch_designs/eyeriss_like/constraints_gemm/*",
    "simba_like":        "../arch_designs/simba_like/constraints_gemm/*",
}
