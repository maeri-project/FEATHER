# FEATHER — ISCA'24 Artifact Evaluation

This document collects the artifact-evaluation steps for the ISCA'24 paper. For
a functionality-oriented overview of the repository (including the MINISA
toolchain in `minisa/`), see [`README.md`](README.md).
